...
plt.figure(), plt.imshow(dst2), plt.axis("off"), plt.title("MEAN BLUR")


# Gaussian Bulanıklaştırma Yöntemi
...
def saltPepperNoise(image):
    ...
    #salt   #np.ceil sayıyı yuvarlama islemi yapar
    num_salt = np.ceil(amount * image.size * s_vs_p)   #size img icindeki pikseller
