import cv2
import numpy as np
from collections import deque  #listemele islemi noktaların yanyana tutulması
...
cv2.putText(paintWindow,"GREEEN",(298,33),font,0.5,(255,255,255),2,cv2.LINE_AA)
...
while 1:
    ...
    cv2.putText(frame,"GREEEN",(298,33),font,0.5,(255,255,255),2,cv2.LINE_AA)
    ...
    if len(contours) > 0:
        ...
        M = cv2.moments(max_contours)  #merkez noktalar
